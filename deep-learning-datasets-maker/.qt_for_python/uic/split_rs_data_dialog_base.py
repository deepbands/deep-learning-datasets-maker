...
class Ui_SplitRSDataDialogBase(object):
    def setupUi(self, SplitRSDataDialogBase):
        ...
        SplitRSDataDialogBase.resize(440, 280)
        ...
        self.widget = QtWidgets.QWidget(SplitRSDataDialogBase)
        self.widget.setGeometry(QtCore.QRect(11, 11, 416, 260))
        ...
        self.mMapLayerComboBoxR = QgsMapLayerComboBox(self.widget)
        ...
        self.mMapLayerComboBoxV = QgsMapLayerComboBox(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.comboBoxImgSize = QtWidgets.QComboBox(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.mQfwRasterized = QgsFileWidget(self.widget)
        ...
        self.mQfwImages = QgsFileWidget(self.widget)
        ...
        self.mQfwLabels = QgsFileWidget(self.widget)
        ...
        self.checkBoxInSeg = QtWidgets.QCheckBox(self.widget)
        ...
        self.mQfwLabels_InSeg = QgsFileWidget(self.widget)
