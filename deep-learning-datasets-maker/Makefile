...
SOURCES = \
	__init__.py \
	split_rs_data.py split_rs_data_dialog.py

PLUGINNAME = split_rs_data

PY_FILES = \
	__init__.py \
	split_rs_data.py split_rs_data_dialog.py

UI_FILES = split_rs_data_dialog_base.ui
...
QGISDIR=C:\Users\Youss\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
